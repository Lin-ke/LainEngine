...
public:
	...
	Test1ShaderRD() {
		...
		Error err;
		Ref<FileAccess> file1 = FileAccess::open("D:/LainEngine/game/test1.glsl.gen.vertex.lglsl", FileAccess::READ,  &err);
		DEV_ASSERT(err == OK);
		static const String _vertex_code = file1->get_as_utf8_string();
		Ref<FileAccess> file2 = FileAccess::open("D:/LainEngine/game/test1.glsl.gen.fragment.lglsl", FileAccess::READ,  &err);
		DEV_ASSERT(err == OK);
