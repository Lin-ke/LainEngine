...
public:
	...
	void add_surface(Mesh::PrimitiveType p_primitive, const Array &p_arrays, const Array &p_blend_shapes = Array(), const Dictionary &p_lods = Dictionary(), const Ref<Material> &p_material = Ref<Material>(), const String &p_name = String(), const uint64_t p_flags = 0);
...
class ResourceImporterOBJ: public ResourceImporter{
  LCLASS(ResourceImporterOBJ, ResourceImporter)
  public:
...
class ResourceFormatLoaderOBJ: public ResourceFormatLoader{
  LCLASS(ResourceFormatLoaderOBJ, ResourceFormatLoader)
  public:
	virtual Ref<Resource> load(const String& p_path, const String& p_original_path = "", Error* r_error = nullptr, bool p_use_sub_threads = false, float* r_progress = nullptr, CacheMode p_cache_mode = CACHE_MODE_REUSE) override;

  virtual void get_recognized_extensions(List<String>* p_extensions) const override;
  virtual void get_recognized_resources(List<String>* p_extensions) const override;
  ResourceFormatLoaderOBJ(){}
};
}
