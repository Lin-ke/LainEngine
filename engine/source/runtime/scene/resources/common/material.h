...
class ShaderMaterial : public Material {
	LCLASS(ShaderMaterial, Material);
	Ref<Shader> shader;
...
class BaseMaterial3D : public Material {
	LCLASS(BaseMaterial3D, Material);
...
class ORMMaterial3D : public BaseMaterial3D {
	LCLASS(ORMMaterial3D, BaseMaterial3D)
public:
	ORMMaterial3D() :
			BaseMaterial3D(true) {}
};
...
class PlaceholderMaterial : public Material {
	LCLASS(PlaceholderMaterial, Material)
public:
