...
/* REFLECTION PROBE */
 ...
 public:
  ...
  _FORCE_INLINE_ int directional_shadow_get_size() { return directional_shadow.size; }
  L_INLINE RID directional_shadow_get_texture() { return directional_shadow.depth; }
  ...
  _FORCE_INLINE_ RID direction_shadow_get_fb() { return directional_shadow.fb; }

  _FORCE_INLINE_ void directional_shadow_increase_current_light() { directional_shadow.current_light++; }
  ...
  _FORCE_INLINE_ uint64_t lightmap_array_get_version() const { return 0; }
 ...
 private:
  ...
  // shadow pair
  bool _shadow_atlas_find_omni_shadows(ShadowAtlas* shadow_atlas, int* p_in_quadrants, int p_quadrant_count, int p_current_subdiv, uint64_t p_tick, int& r_quadrant,
                                       int& r_shadow);
  // 新建texture
