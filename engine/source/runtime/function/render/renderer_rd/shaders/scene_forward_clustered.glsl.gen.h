...
public:
	...
	SceneForwardClusteredShaderRD() {
		...
		Error err;
		Ref<FileAccess> file1 = FileAccess::open("C:/LainEngine/engine/source/runtime/function/render/renderer_rd/shaders/scene_forward_clustered.glsl.gen.vertex.lglsl", FileAccess::READ,  &err);
		DEV_ASSERT(err == OK);
		static const String _vertex_code = file1->get_as_utf8_string();
		Ref<FileAccess> file2 = FileAccess::open("C:/LainEngine/engine/source/runtime/function/render/renderer_rd/shaders/scene_forward_clustered.glsl.gen.fragment.lglsl", FileAccess::READ,  &err);
		DEV_ASSERT(err == OK);
