...
public:
	...
	CopyShaderRD() {
		...
		Error err;
		Ref<FileAccess> file = FileAccess::open("D:/LainEngine/engine/source/runtime/function/render/renderer_rd/shaders/copy.glsl.gen.compute.lglsl", FileAccess::READ,  &err);
		DEV_ASSERT(err == OK);
