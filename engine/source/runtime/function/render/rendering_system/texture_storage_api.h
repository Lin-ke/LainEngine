#ifndef TEXTURE_STORAGE_API_H
#define TEXTURE_STORAGE_API_H
...
class RendererTextureStorage {
 ...
 public:
  void set_default_clear_color(const Color& p_color) { default_clear_color = p_color; }

  Color get_default_clear_color() const { return default_clear_color; }
  ...
  virtual void texture_2d_layered_placeholder_initialize(RID p_texture, RS::TextureLayeredType p_layered_type) = 0;
