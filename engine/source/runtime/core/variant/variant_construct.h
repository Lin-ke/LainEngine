...
MAKE_PTRCONSTRUCT(GObjectPath);
MAKE_PTRCONSTRUCT(RID);

template <>
struct PtrConstruct<Object*> {
  _FORCE_INLINE_ static void construct(Object* p_value, void* p_ptr) { *((Object**)p_ptr) = p_value; }
};
...
class VariantConstructor {
  template <size_t... Is>  // 一个整数值Is，长度是sizeof...(P)
 ...
 public:
  ...
  static void ptr_construct(void* base, const void** p_args) { ptr_construct_helper(base, p_args, BuildIndexSequence<sizeof...(P)>{}); }

  static int get_argument_count() { return sizeof...(P); }

  static Variant::Type get_argument_type(int p_arg) { return call_get_argument_type<P...>(p_arg); }

  static Variant::Type get_base_type() { return GetTypeInfo<T>::VARIANT_TYPE; }
};
...
class VariantConstructorObject {
 public:
  ...
  static void ptr_construct(void* base, const void** p_args) { PtrConstruct<Object*>::construct(PtrToArg<Object*>::convert(p_args[0]), base); }

  static int get_argument_count() { return 1; }

  static Variant::Type get_argument_type(int p_arg) { return Variant::OBJECT; }

  static Variant::Type get_base_type() { return Variant::OBJECT; }
};
...
class VariantConstructorNilObject {
 public:
  ...
  static void ptr_construct(void* base, const void** p_args) { PtrConstruct<Object*>::construct(nullptr, base); }

  static int get_argument_count() { return 1; }

  static Variant::Type get_argument_type(int p_arg) { return Variant::NIL; }
...
class VariantConstructorFromString {
 public:
  ...
  static Variant::Type get_argument_type(int p_arg) { return Variant::STRING; }
...
class VariantConstructorCallableArgs {
 public:
  ...
  static int get_argument_count() { return 2; }
  ...
  static Variant::Type get_base_type() { return Variant::CALLABLE; }
};
...
class VariantConstructorSignalArgs {
 public:
  ...
  static Variant::Type get_base_type() { return Variant::SIGNAL; }
};
...
class VariantConstructorTypedArray {
 public:
  ...
  static int get_argument_count() { return 4; }
  ...
  static Variant::Type get_base_type() { return Variant::ARRAY; }
};
...
class VariantConstructorToArray {
 public:
  ...
  static Variant::Type get_argument_type(int p_arg) { return GetTypeInfo<T>::VARIANT_TYPE; }
...
class VariantConstructorFromArray {
 public:
  ...
  static void ptr_construct(void* base, const void** p_args) {
    ...
    dst_arr.resize(size);
    for (int i = 0; i < size; i++) {
      dst_arr.write[i] = src_arr[i];  // 依赖于该类的实现不准有operator=，否则会有多个匹配
    }
  ...
  static Variant::Type get_argument_type(int p_arg) { return Variant::ARRAY; }
...
class VariantConstructorNil {
 public:
  ...
  static inline void validated_construct(Variant* r_ret, const Variant** p_args) { VariantInternal::clear(r_ret); }
  static void ptr_construct(void* base, const void** p_args) { PtrConstruct<Variant>::construct(Variant(), base); }

  static int get_argument_count() { return 1; }

  static Variant::Type get_argument_type(int p_arg) { return Variant::NIL; }

  static Variant::Type get_base_type() { return Variant::NIL; }
};
...
class VariantConstructNoArgs {
 public:
  ...
  static inline void validated_construct(Variant* r_ret, const Variant** p_args) { VariantTypeChanger<T>::change_and_reset(r_ret); }
  static void ptr_construct(void* base, const void** p_args) { PtrConstruct<T>::construct(T(), base); }

  static int get_argument_count() { return 0; }
...
class VariantConstructNoArgsNil {
 public:
  ...
  static inline void validated_construct(Variant* r_ret, const Variant** p_args) { VariantInternal::clear(r_ret); }
  static void ptr_construct(void* base, const void** p_args) { ERR_FAIL_MSG("Cannot ptrcall nil constructor"); }
