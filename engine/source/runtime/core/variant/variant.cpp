...
bool Variant::can_convert(Variant::Type p_type_from, Variant::Type p_type_to) {
  ...
  switch (p_type_to) {
    ...
    case TRANSFORM2D: {
      static const Type valid[] = {TRANSFORM3D, NIL};
    ...
    case QUATERNION: {
      static const Type valid[] = {BASIS, NIL};

      valid_types = valid;

    } break;
    case BASIS: {
      static const Type valid[] = {QUATERNION, NIL};

      valid_types = valid;

    } break;
    case TRANSFORM3D: {
      static const Type valid[] = {TRANSFORM2D, QUATERNION, BASIS, PROJECTION, NIL};
    ...
    case RID: {
      static const Type valid[] = {OBJECT, NIL};

      valid_types = valid;
    } break;
    case OBJECT: {
      static const Type valid[] = {NIL};

      valid_types = valid;
    } break;
    case STRING_NAME: {
      static const Type valid[] = {STRING, NIL};
    ...
    case ARRAY: {
      static const Type valid[] = {PACKED_BYTE_ARRAY,
                                   PACKED_INT32_ARRAY,
                                   PACKED_INT64_ARRAY,
...
bool Variant::can_convert_strict(Variant::Type p_type_from, Variant::Type p_type_to) {
  ...
  switch (p_type_to) {
    ...
    case STRING: {
      static const Type valid[] = {GOBJECT_PATH, STRING_NAME, NIL};
...
bool Variant::is_zero() const {
  switch (type) {
    ...
    case GOBJECT_PATH: {
      return reinterpret_cast<const GObjectPath*>(_data._mem)->is_empty();
    }
    case DICTIONARY: {
...
String Variant::to_json_string() const {
  return Serializer::write(*this).dump();
}
...
Variant::Variant(bool p_bool) : type(BOOL) {
  _data._bool = p_bool;
}

Variant::Variant(int64_t p_int64) : type(INT) {
  _data._int = p_int64;
}

Variant::Variant(int32_t p_int32) : type(INT) {
  _data._int = p_int32;
}

Variant::Variant(int16_t p_int16) : type(INT) {
  _data._int = p_int16;
}

Variant::Variant(int8_t p_int8) : type(INT) {
  _data._int = p_int8;
}

Variant::Variant(uint64_t p_uint64) : type(INT) {
  _data._int = p_uint64;
}

Variant::Variant(uint32_t p_uint32) : type(INT) {
  _data._int = p_uint32;
}

Variant::Variant(uint16_t p_uint16) : type(INT) {
  _data._int = p_uint16;
}

Variant::Variant(uint8_t p_uint8) : type(INT) {
  _data._int = p_uint8;
}

Variant::Variant(float p_float) : type(FLOAT) {
  _data._float = p_float;
}

Variant::Variant(double p_double) : type(FLOAT) {
  _data._float = p_double;
}

Variant::Variant(const ObjectID& p_id) : type(INT) {
  _data._int = p_id;
}
...
Variant::Variant(const char* const p_cstring) : type(STRING) {
  memnew_placement(_data._mem, String((const char*)p_cstring));
}

Variant::Variant(const char32_t* p_wstring) : type(STRING) {
  memnew_placement(_data._mem, String(p_wstring));
}

Variant::Variant(const Vector3& p_vector3) : type(VECTOR3) {
  memnew_placement(_data._mem, Vector3(p_vector3));
}

Variant::Variant(const Vector3i& p_vector3i) : type(VECTOR3I) {
...
Variant::Variant(const Vector4i& p_vector4i) : type(VECTOR4I) {
  memnew_placement(_data._mem, Vector4i(p_vector4i));
}

Variant::Variant(const Vector2& p_vector2) : type(VECTOR2) {
  memnew_placement(_data._mem, Vector2(p_vector2));
}

Variant::Variant(const Vector2i& p_vector2i) : type(VECTOR2I) {
  memnew_placement(_data._mem, Vector2i(p_vector2i));
}

Variant::Variant(const Rect2& p_rect2) : type(RECT2) {
  memnew_placement(_data._mem, Rect2(p_rect2));
}

Variant::Variant(const Rect2i& p_rect2i) : type(RECT2I) {
  memnew_placement(_data._mem, Rect2i(p_rect2i));
}

Variant::Variant(const Plane& p_plane) : type(PLANE) {
...
Variant::Variant(const Quaternion& p_quaternion) : type(QUATERNION) {
  memnew_placement(_data._mem, Quaternion(p_quaternion));
}

Variant::Variant(const Transform3D& p_transform) : type(TRANSFORM3D) {
  _data._transform3d = (Transform3D*)Pools::_bucket_medium.alloc();
  memnew_placement(_data._transform3d, Transform3D(p_transform));
}

Variant::Variant(const Projection& pp_projection) : type(PROJECTION) {
  _data._projection = (Projection*)Pools::_bucket_large.alloc();
  memnew_placement(_data._projection, Projection(pp_projection));
}

Variant::Variant(const Transform2D& p_transform) : type(TRANSFORM2D) {
  _data._transform2d = (Transform2D*)Pools::_bucket_small.alloc();
  memnew_placement(_data._transform2d, Transform2D(p_transform));
}

Variant::Variant(const Color& p_color) : type(COLOR) {
  memnew_placement(_data._mem, Color(p_color));
}

Variant::Variant(const GObjectPath& p_GOBJECT_PATH) : type(GOBJECT_PATH) {
...
Variant::Variant(const Signal& p_callable) : type(SIGNAL) {
  memnew_placement(_data._mem, Signal(p_callable));
}

Variant::Variant(const Dictionary& p_dictionary) : type(DICTIONARY) {
...
Variant::Variant(const PackedByteArray& p_byte_array) : type(PACKED_BYTE_ARRAY) {
  _data.packed_array = PackedArrayRef<uint8_t>::create(p_byte_array);
}

Variant::Variant(const PackedInt32Array& p_int32_array) : type(PACKED_INT32_ARRAY) {
  _data.packed_array = PackedArrayRef<int32_t>::create(p_int32_array);
}

Variant::Variant(const PackedInt64Array& p_int64_array) : type(PACKED_INT64_ARRAY) {
  _data.packed_array = PackedArrayRef<int64_t>::create(p_int64_array);
}

Variant::Variant(const PackedFloat32Array& p_float32_array) : type(PACKED_FLOAT32_ARRAY) {
...
Variant::Variant(const PackedStringArray& p_string_array) : type(PACKED_STRING_ARRAY) {
  _data.packed_array = PackedArrayRef<String>::create(p_string_array);
}

Variant::Variant(const PackedVector2Array& p_vector2_array) : type(PACKED_VECTOR2_ARRAY) {
  _data.packed_array = PackedArrayRef<Vector2>::create(p_vector2_array);
}

Variant::Variant(const PackedVector3Array& p_vector3_array) : type(PACKED_VECTOR3_ARRAY) {
  _data.packed_array = PackedArrayRef<Vector3>::create(p_vector3_array);
}

Variant::Variant(const PackedColorArray& p_color_array) : type(PACKED_COLOR_ARRAY) {
  _data.packed_array = PackedArrayRef<Color>::create(p_color_array);
}

Variant::Variant(const PackedVector4Array& p_vector4_array) : type(PACKED_VECTOR4_ARRAY) {
...
Variant::Variant(const Vector<Plane>& p_array) : type(ARRAY) {
...
Variant::Variant(const Vector<Face3>& p_face_array) : type(NIL) {
...
Variant::Variant(const Vector<Variant>& p_array) : type(NIL) {
  Array arr;
...
Variant::Variant(const Vector<StringName>& p_array) : type(NIL) {
  PackedStringArray v;
...
Variant::Variant(const IPAddress& p_address) : type(STRING) {
  memnew_placement(_data._mem, String(p_address));
}

Variant::Variant(const Variant& p_variant) : type(NIL) {
  reference(p_variant);
}
...
#define hash_compare_scalar_base(p_lhs, p_rhs, semantic_comparison) (((p_lhs) == (p_rhs)) || (semantic_comparison && Math::is_nan(p_lhs) && Math::is_nan(p_rhs)))

#define hash_compare_scalar(p_lhs, p_rhs) (hash_compare_scalar_base(p_lhs, p_rhs, true))

#define hash_compare_vector2(p_lhs, p_rhs) (hash_compare_scalar((p_lhs).x, (p_rhs).x) && hash_compare_scalar((p_lhs).y, (p_rhs).y))

#define hash_compare_vector3(p_lhs, p_rhs) \
  (hash_compare_scalar((p_lhs).x, (p_rhs).x) && hash_compare_scalar((p_lhs).y, (p_rhs).y) && hash_compare_scalar((p_lhs).z, (p_rhs).z))
...
#define hash_compare_color(p_lhs, p_rhs)                                                                                                  \
  (hash_compare_scalar((p_lhs).r, (p_rhs).r) && hash_compare_scalar((p_lhs).g, (p_rhs).g) && hash_compare_scalar((p_lhs).b, (p_rhs).b) && \
...
bool Variant::hash_compare(const Variant& p_variant, int recursion_count, bool semantic_comparison) const {
  ...
  switch (type) {
    ...
    case RECT2: {
      ...
      return hash_compare_vector2(l->position, r->position) && hash_compare_vector2(l->size, r->size);
    } break;
    case RECT2I: {
    ...
    case PLANE: {
      ...
      return hash_compare_vector3(l->normal, r->normal) && hash_compare_scalar(l->d, r->d);
    } break;
...
bool Variant::is_type_shared(Variant::Type p_type) const {
  switch (p_type) {
    case OBJECT:
    case ARRAY:
    case DICTIONARY:
...
String Variant::get_call_error_text(Object* p_base, const StringName& p_method, const Variant** p_argptrs, int p_argcount, const Callable::CallError& ce) {
  ...
  if (ce.error == Callable::CallError::CALL_ERROR_INVALID_ARGUMENT) {
    ...
    if (p_argptrs) {
      err_text = "Cannot convert argument " + itos(errorarg + 1) + " from " + Variant::get_type_name(p_argptrs[errorarg]->get_type()) + " to " +
                 Variant::get_type_name(Variant::Type(ce.expected));
    } else {
