...
Error ImageLoaderPNG::load_image(Ref<Image> p_image, Ref<FileAccess> f,  BitField<ImageLoader::LoaderFlags> p_flags, float p_scale) {
	...
	return PNGDriverCommon::png_to_image(reader, buffer_size, p_flags & ImageLoader::FLAG_FORCE_LINEAR, p_image);
}
