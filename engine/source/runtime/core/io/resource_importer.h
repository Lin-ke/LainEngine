...
class ResourceFormatImporter : public ResourceFormatLoader {
  ...
  Error _get_path_and_type(const String& p_path, ImportPathAndType& r_path_and_type, bool* r_valid = nullptr) const;
...
class ResourceImporter : public RefCounted {
  LCLASS(ResourceImporter, RefCounted);
...
//   virtual bool get_option_visibility(const String& p_path, const String& p_option, const HashMap<StringName, Variant>& p_options) const = 0;
  ...
  virtual Error import(const String& p_source_file, const String& p_save_path, const HashMap<StringName, Variant>& p_options, List<String>* r_platform_variants,
  ...
  virtual Error import_group_file(const String& p_group_file, const HashMap<String, HashMap<StringName, Variant>>& p_source_file_options,
                                  const HashMap<String, String>& p_base_paths) {
...
class ResourceFormatImporterSaver : public ResourceFormatSaver {
  LCLASS(ResourceFormatImporterSaver, ResourceFormatSaver)
