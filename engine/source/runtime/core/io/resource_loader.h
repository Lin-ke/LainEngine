...
class ResourceFormatLoader : public RefCounted {
 ...
 public:
  ...
  virtual void get_recognized_resources(List<String>* p_classes) const {}
...
class ResourceLoader {
 ...
 public:
  ...
  static Ref<Resource> load(const String& p_path, const String& p_type_hint = "", ResourceFormatLoader::CacheMode p_cache_mode = ResourceFormatLoader::CACHE_MODE_REUSE,
 ...
 private:
  ...
  static Ref<Resource> _load(const String& p_path, const String& p_original_path, const String& p_type_hint, ResourceFormatLoader::CacheMode p_cache_mode, Error* r_error,
                             bool p_use_sub_threads, float* r_progress);
