...
Variant PropertyUtils::get_property_default_value(const Object* p_object, const StringName& p_property, bool* r_is_valid,
                                                  const Vector<SceneState::PackState>* p_states_stack_cache, bool p_update_exports, const GObject* p_owner,
                                                  bool* r_is_class_default) {
...
Variant PropertyUtils::get_property_default_value(const Ref<Resource> p_object, const StringName& p_property, bool* r_is_valid,
                                                  const Vector<SceneState::PackState>* p_states_stack_cache, bool p_update_exports, const GObject* p_owner,
                                                  bool* r_is_class_default) {
  PropertyInfo value;
  Variant ret;
